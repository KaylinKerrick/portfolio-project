...
- Designed a proof of concept for the StageLight component
- Designed three kernel methods, and one secondary method
- Designed a main method to prove concept works
